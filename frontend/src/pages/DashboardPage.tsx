...
import { MetricCard, MetricGrid } from "../components/metrics";
    ...
    <div className="space-y-6">
      ...
      {metrics ? (
        ...
        <div className="space-y-3">
          ...
          <h3 className="text-lg font-medium">Live traffic (24h)</h3>

          <MetricGrid>

            <MetricCard label="Requests/sec" value={metrics.live_traffic.requests_per_second.toFixed(3)} />

            <MetricCard label="Active connections" value={String(metrics.live_traffic.active_connections)} />

            <MetricCard label="Avg latency" value={`${metrics.live_traffic.avg_response_time_ms.toFixed(1)} ms`} />

            <MetricCard

              label="Error rate"

              value={`${metrics.live_traffic.error_rate_percent.toFixed(2)}%`}

              tone={metrics.live_traffic.error_rate_percent > 5 ? "danger" : "success"}
